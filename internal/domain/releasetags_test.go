...
func TestParseReleaseTagString(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "movies_2", args: args{tags: "HEVC DynamicRange Blu-ray mp4 2160p"}, want: ReleaseTags{Codec: "HEVC", Source: "BluRay", Resolution: "2160p", Container: "mp4", HDR: []string{"DynamicRange"}}},
		{name: "movies_3", args: args{tags: "HEVC DynamicRange DV Blu-ray mp4 2160p"}, want: ReleaseTags{Codec: "HEVC", Source: "BluRay", Resolution: "2160p", Container: "mp4", HDR: []string{"DynamicRange", "DV"}}},
