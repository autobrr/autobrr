...
func NewNotifiarrSender(log zerolog.Logger, settings *domain.Notification) *notifiarrSender {
	return &notifiarrSender{
		baseSender: newBaseSender("notifiarr", settings),
...
func (s *notifiarrSender) Send(ctx context.Context, payload domain.NotificationPayload) error {
