...
func NewDiscordSender(log zerolog.Logger, settings *domain.Notification) *discordSender {
	return &discordSender{
		baseSender: newBaseSender("discord", settings),
...
func (s *discordSender) Send(ctx context.Context, payload domain.NotificationPayload) error {
