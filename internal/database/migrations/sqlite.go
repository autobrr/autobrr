...
func SQLiteMigrations(db *sql.DB, logger zerolog.Logger) *migrator.Migrator {
	...
	migrate.AddFileMigration("91_irc_update_darkpeers_network.sql")
	migrate.AddFileMigration("92_indexers_rename_rotorrent_to_seedcore.sql")
	migrate.AddFileMigration("93_create_release_filter_status_index.sql")
	migrate.AddFileMigration("94_feeds_add_user_agent.sql")
	migrate.AddFileMigration("95_add_indexer_archived_and_deprecation.sql")
	migrate.AddFileMigration("96_irc_update_samaritano_port_and_tls.sql")
	migrate.AddFileMigration("97_add_filter_max_downloads_period.sql")
	migrate.AddFileMigration("98_add_filter_external_arr_client_columns.sql")
