...
function SlideOver<DataType extends object>({
  title,
  initialValues,
  onSubmit,
  deleteAction,
                ...
                <form.AppForm>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {children !== undefined ? (
                        children(form.state.values as DataType)
                      ) : null}
                    </div>
                      ...
                      <div className={classNames(type === "CREATE" ? "justify-end" : "justify-between", "space-x-3 flex")}>
                        ...
                        <div className="flex">
                          {extraButtons !== undefined && (
                            extraButtons(form.state.values as DataType)
                          )}
