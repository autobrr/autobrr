...
interface RadioFieldsetWideProps {
  legend: string;
  options: radioFieldsetOption[];
}

function RadioFieldsetWide({ legend, options }: RadioFieldsetWideProps) {
      ...
      <div className="space-y-2 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:py-4">
        ...
        <div className="space-y-5 sm:col-span-2">
          <div className="space-y-5 sm:mt-0">
            <RadioGroup value={field.state.value} onChange={(value) => field.handleChange(value)}>
