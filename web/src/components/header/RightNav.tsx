              ...
              <>
                ...
                >
                  <span className="hidden hover:cursor-pointer text-sm font-medium sm:flex items-center">
                    <Cog6ToothIcon className="inline h-5 w-5" aria-hidden="true" />
                  </span>
                </MenuButton>
                <Transition
                  show={open}
                ...
                >
                  <MenuItems
                    static
                    className="origin-top-right absolute right-0 mt-2 w-48 z-10 rounded-md shadow-lg bg-white dark:bg-gray-800 border border-gray-250 dark:border-gray-775 focus:outline-hidden"
                  >
                    <MenuItem>
                      {({ active }) => (
                        <Link
                          ...
                          className={classNames(
                            active
                              ...
                              : "",
                            "flex items-center transition rounded-md px-2 py-2 text-sm text-gray-900 dark:text-gray-200"
                          )}
                        >
                          <Cog6ToothIcon
