    ...
    <div className="py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
      ...
      <dd className="mt-1 text-gray-900 dark:text-white sm:mt-0 sm:col-span-2 break-all">
        ...
        {newUpdate && newUpdate.html_url && (
          <span>
            <a href={newUpdate.html_url} target="_blank" rel="noreferrer"><span className="ml-2 inline-flex items-center rounded-md bg-green-100 px-2.5 py-0.5 text-sm font-medium text-green-800">{newUpdate.name} available!</span></a>
          </span>
        )}
      </dd>
    </div>
