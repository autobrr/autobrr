...
const ListboxFilter = ({
  ...
  >
    <div className="relative">
      ...
      >
        <Listbox.Options
          className="w-52 absolute z-10 mt-1 right-0 text-base bg-white dark:bg-gray-800 rounded-md shadow-lg max-h-60 border border-opacity-5 border-black dark:border-gray-700 dark:border-opacity-40 focus:outline-none sm:text-sm scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800 overflow-y-scroll scrollbar-thumb-rounded-full scrollbar-track-rounded-full"
        >
          {children}
        </Listbox.Options>
      </Transition>
