    ...
    <FilterPage>
      <FilterSection>
        <FilterLayout>
          <ContextField name="name">
            <TextField label="Filter name" columns={6} placeholder="eg. Filter 1" />
          </ContextField>

          <ContextField name="announce_types">
            <MultiSelect
          ...
          <ContextField name="indexers">
            <IndexerMultiSelect options={indexerOptions} label="Indexers" columns={3} />
          </ContextField>
        </FilterLayout>
      </FilterSection>
      ...
      >
        <FilterLayout>
          ...
          <ContextField name="max_downloads">
            <NumberField
              label="Max downloads"
          ...
          <ContextField name="max_downloads_unit">
            <Select
          ...
          <ContextField name="release_profile_duplicate_id">
            <Select
