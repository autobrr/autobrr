    ...
    <div>
      ...
      <div className="mt-6 lg:pb-8">
        ...
        <div className="mt-6 grid grid-cols-12 gap-6">
          ...
          <NumberField name="max_downloads" label="Max downloads" placeholder="Takes any number (0 is infinite)" min={0} tooltip={<div><p>Number of max downloads as specified by the respective unit.</p><a href='https://autobrr.com/filters#rules' className='text-blue-400 visited:text-blue-400' target='_blank'>https://autobrr.com/filters#rules</a></div>} />
