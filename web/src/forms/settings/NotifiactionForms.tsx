...
import { NotificationTypeOptions } from "../../domain/constants";
...
function FormFieldsDiscord() {
    return (
        <div className="border-t border-gray-200 dark:border-gray-700 py-5">
            ...
            <TextFieldWide name="webhook" label="Webhook URL" help="Discord channel webhook url" placeholder="https://discordapp.com/api/webhooks/xx/xx" />
        </div>
    );
}
                                                        ...
                                                        <fieldset className="space-y-5">
                                                            ...
                                                            <div className="relative flex items-start">
                                                                ...
                                                                <div className="ml-3 text-sm">
                                                                    <label htmlFor="events" className="font-medium text-gray-900 dark:text-gray-100">
                                                                        Push Approved
                                                                    </label>
